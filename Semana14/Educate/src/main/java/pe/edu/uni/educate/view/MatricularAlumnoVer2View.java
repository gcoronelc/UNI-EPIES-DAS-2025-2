 ...
 */
public class MatricularAlumnoVer2View extends javax.swing.JInternalFrame {
	 ...
	 */
	public MatricularAlumnoVer2View() {
		initComponents();
		controller = new ProcesosController();
		llenarComboCursos();
	}
	...
	private void llenarComboCursos() {
		try {
			// Datos
			List<ComboDto> lista = controller.getCursoActivos();
			// Llenar el combo
			cboCurso.removeAllItems();
			for (ComboDto bean : lista) {
				cboCurso.addItem(bean);
			}
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cboCurso, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cboAlumno, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
   ...
   private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
	   ...
	   if (cboAlumno.getSelectedIndex() == -1) {
		   Mensaje.error(this, "Debe seleccionar los datos correcpondientes!!!");
		   return;
	   }
	   try {
		   // Datos
    ...
    private void cboCursoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboCursoActionPerformed
		...
		ComboDto curso = (ComboDto) cboCurso.getSelectedItem();
		try {
			List<ComboDto> lista = controller.getAlumnosDisponibles(curso.getId());
			for (ComboDto bean : lista) {
				cboAlumno.addItem(bean);
			}
